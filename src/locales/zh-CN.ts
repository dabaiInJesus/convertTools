...
export default {
  ...
  textTools: {
    ...
    plainText: '纯文本',
    placeholder: '在此输入文本...',
    pastePlaceholder: '在此粘贴 {format} 内容...',
  },
  ...
  ui: {
    copied: '✅ 已复制！',
    copy: '📋 复制',
    downloadAllZip: '⬇️ 下载全部 (ZIP)',
    dropFileText: '拖拽文件到此处或点击浏览',
    pasteTextPlaceholder: '在此粘贴 {format} 内容...',
    enterTextPlaceholder: '在此输入文本...',
    converting: '⚡ 转换中...',
    convertTo: '🔄 转换为 {format}',
    outputTitle: '输出结果 ({format})',
    ...
    uploadFile: '📁 上传文件',
    pasteText: '⌨️ 粘贴文本',
    batchConvertPro: '批量转换 (专业版)',
    selectMultipleFiles: '📂 选择多个文件',
    lightningFast: '闪电般快速',
    fastDesc: '在浏览器中即时转换文件。无需服务器上传。',
    private: '100% 隐私保护',
    privateDesc: '您的文件永远不会离开设备。所有操作都在本地运行。',
    freeForever: '100% 免费',
    freeDesc: '无限制、无需注册、无广告。永远开源。',
    builtBy: '由',
    poweredBy: '驱动 · 基于 Vue3',
    close: '关闭',
    cancel: '取消',
